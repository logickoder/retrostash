 ...
 *
 * @property getMaxAgeSeconds max-age value used when rewriting GET cache-control headers.
 * @property enableGetCaching enables GET cache-control rewriting.
 ...
 * @property logger optional logger invoked for cache-control decisions, response source labels,
 * and mutation events.
 */
